...
interface EarningsEvent {
  ...
  symbol: string;
  date: string;
  timeKey: 'beforeOpen' | 'afterClose';
  estimate: string;
  actual?: string;
}

const upcomingEarnings: EarningsEvent[] = [
  { company: 'Apple Inc.', symbol: 'AAPL', date: 'Jan 30', timeKey: 'afterClose', estimate: '$2.35' },
  { company: 'Microsoft Corp.', symbol: 'MSFT', date: 'Jan 28', timeKey: 'afterClose', estimate: '$3.12' },
  { company: 'Alphabet Inc.', symbol: 'GOOGL', date: 'Feb 4', timeKey: 'afterClose', estimate: '$2.01' },
  { company: 'Amazon.com Inc.', symbol: 'AMZN', date: 'Feb 6', timeKey: 'afterClose', estimate: '$1.48' },
  { company: 'Meta Platforms', symbol: 'META', date: 'Jan 29', timeKey: 'afterClose', estimate: '$6.72' },
  { company: 'NVIDIA Corp.', symbol: 'NVDA', date: 'Feb 26', timeKey: 'afterClose', estimate: '$0.84' },
];

const recentEarnings: EarningsEvent[] = [
  { company: 'Tesla Inc.', symbol: 'TSLA', date: 'Jan 23', timeKey: 'afterClose', estimate: '$0.73', actual: '$0.71' },
  { company: 'Netflix Inc.', symbol: 'NFLX', date: 'Jan 21', timeKey: 'afterClose', estimate: '$4.18', actual: '$4.27' },
];
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-slate-500">
                    {t(`ghost.modules.finance.views.earnings.${event.timeKey}`)}
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <span className={`text-xs font-medium px-2 py-1 rounded ${beat ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}>
                      {beat ? t('ghost.modules.finance.views.earnings.beat') : t('ghost.modules.finance.views.earnings.miss')}
                    </span>
                  </div>
                </div>
              </Card>
