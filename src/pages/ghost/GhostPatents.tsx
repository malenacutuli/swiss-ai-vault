...
export default function GhostPatents() {
  ...
  const categories = [
    { name: 'Computers & Software', color: 'from-blue-900 to-blue-700' },
    { name: 'Medical & Healthcare Technology', color: 'from-teal-900 to-teal-700' },
    { name: 'Industrial Machinery & Manufacturing', color: 'from-purple-900 to-purple-700' },
  ];
    ...
    <div className="flex min-h-screen bg-[#FEFEFB]">
      ...
      <div className="flex-1 flex flex-col items-center justify-start pt-24 px-6">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-semibold text-foreground">Patents</h1>
        </div>
